...
const IndexPage: Page = () => {
    ...
    return (
        <div>
            ...
            <Title>Welcome to Pagi Sore!</Title>
            <h2 className='mb-5 text-3xl'>Welcome to Pagi Sore!</h2>
            <div>
                <Link href='/restaurant/orderPagiSore' className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-block'>
