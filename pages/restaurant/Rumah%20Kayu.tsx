...
const IndexPage: Page = () => {
    ...
    return (
        <div>
            ...
            <Title>Welcome to Rumah Kayu!</Title>
            <h2 className='mb-5 text-3xl'>Welcome to Rumah Kayu!</h2>
            <div>
                <Link href='/restaurant/orderRumahKayu' className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-block'>
